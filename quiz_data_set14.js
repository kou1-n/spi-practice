...
const SET14_QUESTIONS = [
  ...
  },
  {
    ...
    answer: "A",
    explanation: `<p><strong>正答: A</strong></p><h4>解法ステップ</h4><ol><li>キーワード: 「the intellectual sources for the constitution of the United States」（合衆国憲法の知的源泉）</li><li>本文該当: 「the intellectual root of the American political system goes back to Montesquieu's idea of the separation of powers」+ 「Montesquieu's political theories have influenced many American political thinkers and lawmakers of the Enlightenment」</li><li>判定: アメリカの政治システムの知的ルーツがモンテスキューであり、政治思想家や立法者（lawmakers）に影響を与えた → 政治システムの根幹である憲法の知的源泉であることは論理的に導ける → <strong>A</strong></li></ol><h4>解説</h4><p>本文ではモンテスキューの思想が「the intellectual root of the American political system」であると明記し、さらに「political thinkers and lawmakers」に影響を与えたと述べている。アメリカの政治システムの根幹は合衆国憲法であり、立法者（lawmakers）に影響を与えた思想は憲法の知的源泉と見なすのが論理的に妥当である。</p><h4>各選択肢の分析</h4><ul><li><strong>A（正しい）→ ✓ 正解。</strong> 「political system」の知的ルーツであり「lawmakers」に影響を与えたことから、その思想が政治システムの根幹たる憲法の知的源泉であることは論理的に導ける。</li><li>B（間違い）→ モンテスキューが政治システムの知的ルーツであることは明記されており、矛盾する情報はないためBには該当しない。</li><li>C（判断不能）→ 「political system」の知的ルーツが「lawmakers」に影響を与えたと明記されている以上、憲法との関連は十分に導けるためCには該当しない。</li></ul><div class="tip">時短テク: 「intellectual root of political system」+「influenced lawmakers」→ 憲法の知的源泉と読める。</div>`
  },
  {
    id: 386,
    number: 14,
