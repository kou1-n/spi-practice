...
const SET6_QUESTIONS = [
  ...
  },
  {
    ...
    answer: "C",
    explanation: `<p><strong>正答: C</strong></p><p><strong>該当英文:</strong> "we will have a one-hour piano and cello concert in Room 1 on the second floor in our hotel" / "We have only 50 seats"</p><h4>解説</h4><p>コンサートはホテルの2階・Room 1で行われ、座席は50席。</p><h4>誤答選択肢の分析</h4><ul><li>A「ホテルで最も大きい部屋」→ 最も大きい部屋とは書かれていない</li><li>B「ホテル近くのコンサートホール」→ ホテル内のRoom 1で開催</li><li>D「1階」→ "on the second floor"（2階）と明記</li><li>E「ホテルのロビー」→ Room 1で開催であり、ロビーではない</li></ul><div class="tip">読解テク: 場所に関する質問では "in/on/at" の前置詞句をスキャニングして特定する。</div>`
  },
  {
    id: 290,
    number: 5,
    ...
    answer: "D",
    explanation: `<p><strong>正答: D</strong></p><p><strong>該当英文:</strong> "Just in time for the Tokyo Olympics held in 1964, the project materialized and the first commercial Shinkansen operated"</p><h4>解説</h4><p>商業用新幹線は1964年の東京オリンピック開催時に運行を開始した。</p><h4>誤答選択肢の分析</h4><ul><li>A「日本の観光需要が伸びた後」→ 大量輸送の需要（mass transport）が根拠だが観光需要とは異なる。直接的なタイミングはオリンピック</li><li>B「最初の弾丸列車プロジェクトの前」→ 時系列が逆。プロジェクトは1939年、商業運行は1964年</li><li>C「弾丸列車プロジェクトが提案されたとき」→ 提案は1939年だが商業運行は1964年</li><li>E「本文に記載なし」→ 明記されている</li></ul><div class="tip">読解テク: 年号が複数出る文章では、イベントと年号の対応表を頭の中で作ると混同を防げる。</div>`
  },
  {
    id: 291,
    number: 6,
  ...
  },
  {
    ...
    answer: "C",
    explanation: `<p><strong>正答: C</strong></p><p><strong>該当英文:</strong> "For more details, check the CEC website or call us at 234-XXXX."</p><h4>解説</h4><p>インターネットにアクセスできない場合、ウェブサイトは使えないので、電話（call us at 234-XXXX）が唯一の代替手段。</p><h4>誤答選択肢の分析</h4><ul><li>A「地方紙を読む」→ 本文に記載なし</li><li>B「CECにメールを送る」→ メールアドレスの記載はない</li><li>D「イベントのリーフレットを請求する手紙を書く」→ 本文に記載なし</li><li>E「キャンパスの掲示板を確認する」→ 本文に記載なし</li></ul><div class="tip">読解テク: "A or B" 形式で連絡方法が並ぶとき、一方が使えない場合はもう一方が答え。</div>`
  },
  {
    id: 294,
    number: 9,
  ...
  },
  {
    ...
    answer: "A",
    explanation: `<p><strong>正答: A</strong></p><p><strong>該当英文:</strong> "Ethnic dresses, craft works, pictures of famous tourist spots, and several other exotic items" が展示されるもの。</p><h4>解説</h4><p>エスニックダンスショーは一切言及されていない。NOT問題で、展示されないものを選ぶ。</p><h4>誤答選択肢の分析</h4><ul><li>B「工芸品」→ "craft works" として明記されている</li><li>C「外国のアイテム」→ "several other exotic items" として明記されている</li><li>D「エキゾチックなドレス」→ "Ethnic dresses" として明記されている</li><li>E「写真展示」→ "pictures of famous tourist spots" として明記されている</li></ul><div class="tip">読解テク: NOT問題では、本文のリストと選択肢を1つずつ照合する。リストにないものが正答。</div>`
  },
  {
    id: 296,
    number: 11,
    ...
    answer: "E",
    explanation: `<p><strong>正答: E</strong></p><p><strong>該当英文:</strong> "the focal message is that the best technique is not about the technique itself" / "what we should master is 'the spirit of keeping nothing' to make improvisation possible"</p><h4>解説</h4><p>武蔵が伝えたかったのは、技術そのものよりも重要な何か（「無の精神」）を見出したということ。</p><h4>誤答選択肢の分析</h4><ul><li>A「彼は文学の熱烈なファンだった」→ 読者が熱烈なファン（ardent fans）であり武蔵のことではない</li><li>B「試合を生き延びたことに感謝していた」→ そのような記述はない</li><li>C「他の剣士に規律を求めた」→ 武蔵自身の自己鍛錬であり他者への要求ではない</li><li>D「技術を極めた」→ むしろ技術に頼るべきではないというメッセージ</li></ul><div class="tip">読解テク: "the focal message is that..." はメインメッセージの明示。この構文を見つければ正答の根拠に直結する。</div>`
  },
  {
    id: 297,
    number: 12,
    ...
    answer: "C",
    explanation: `<p><strong>正答: C</strong></p><p><strong>該当英文:</strong> "thanks to his strict self-discipline over mind and body literally to win and to live"</p><h4>解説</h4><p>武蔵が60回以上の真剣勝負を生き延びたのは、心身両面にわたる厳格な自己鍛錬のおかげ。</p><h4>誤答選択肢の分析</h4><ul><li>A「有名な剣士だったから」→ 有名であることは生存の理由ではない</li><li>B「剣術が卓越していたから」→ 本文が強調するのは自己鍛錬であり剣術の卓越性ではない</li><li>D「剣術のガイドブックを読んでいたから」→ 武蔵自身が書いたもの。読んだから生き延びたのではない</li><li>E「技術に頼っていたから」→ 本文のメッセージはむしろ技術に頼るべきではないということ</li></ul><div class="tip">読解テク: "thanks to..." は理由・原因を示す表現。直後の名詞句が答えの根拠。</div>`
  },
  {
    id: 298,
    number: 13,
  ...
  },
  {
    ...
    answer: "A",
    explanation: `<p><strong>正答: A</strong></p><p><strong>該当英文:</strong> 本文全体が古代のワインの飲み方（水で薄める習慣とその文化的背景）を扱っている。</p><h4>解説</h4><p>本文の主題は古代ギリシャ・ローマにおけるワインの飲み方。</p><h4>誤答選択肢の分析</h4><ul><li>B「古代の水の飲み方」→ 水の話も出てくるが主題はワインの飲み方</li><li>C「現代のワインの飲み方」→ 本文は古代（ancient times）の話</li><li>D「現代の水の飲み方」→ 古代の話であり水が主題でもない</li><li>E「古代ギリシャ・ローマの文化」→ 範囲が広すぎる。ワインの飲み方に特化</li></ul><div class="tip">読解テク: 主題選択問題では「最も具体的かつ正確」な選択肢を選ぶ。広すぎるもの（E）や部分的なもの（B）は除外。</div>`
  },
  {
    id: 300,
    number: 15,
  ...
  },
  {
    ...
    answer: "C",
    explanation: `<p><strong>正答: C</strong></p><p><strong>該当英文:</strong> "Wine was an everyday drink in both ancient Greek and Roman cultures"</p><h4>解説</h4><p>ワインは日常的な飲み物（everyday drink = common drink）だった。</p><h4>誤答選択肢の分析</h4><ul><li>A「水の代わり」→ ワインを水に加えていた（added wine to water）のであり水の代替品ではない</li><li>B「不道徳の印」→ 不道徳とされたのは「薄めずにワインを飲むこと」でありワインそのものではない</li><li>D「文明の象徴」→ 文明的とされたのは「ワインを水で薄めて飲むこと」でありワインそのものではない</li><li>E「薬」→ 本文に記載なし</li></ul><div class="tip">読解テク: "everyday drink" = "common drink"。形容詞の言い換えパターンを押さえておく。</div>`
  },
  {
    id: 302,
    number: 17,
  ...
  },
  {
    ...
    answer: "E",
    explanation: `<p><strong>正答: E</strong></p><p><strong>該当英文:</strong> 職務内容（Responsibilities）は3つ記載。福利厚生として "If required, company housing can also be offered at low cost" とある。</p><h4>解説</h4><p>選択肢Eの「低コストの社宅を見つけること」は職務ではなく、福利厚生として会社側が提供するもの。</p><h4>誤答選択肢の分析</h4><ul><li>A「外国人をもてなすこと」→ 中国からの客への対応は職務に含まれる</li><li>B「日本人スタッフを研修すること」→ 職務3に該当</li><li>C「中国市場を成長させること」→ 職務1に該当</li><li>D「ウェブサイトを中国語に翻訳すること」→ 職務2に該当</li></ul><div class="tip">読解テク: 求人広告では "Responsibilities" と "Benefits" を区別する。会社が提供するもの（benefits）は職務ではない。</div>`
  },
  {
    id: 306,
    number: 21,
    ...
    answer: "C",
    explanation: `<p><strong>正答: C</strong></p><p><strong>該当英文:</strong> 本文には研修（on-the-job training）に関する記述が一切ない。"At least 3 years' experience in the hospitality industry" が要件。</p><h4>解説</h4><p>OJT（実地研修）の記載はなく、即戦力を想定している。NOT問題で、本文に合致しない記述を選ぶ。</p><h4>誤答選択肢の分析</h4><ul><li>A「中国語に堪能な人を募集中」→ "native fluency in Chinese" と一致</li><li>B「実務経験のない人は応募できない」→ 3年以上の経験要件と一致</li><li>D「正社員を募集中」→ 年俸や福利厚生の提示から正社員募集と判断可能</li><li>E「旅館は年俸380万円を支払う用意がある」→ "Starting annual salary is JPY 3,800,000" と一致</li></ul><div class="tip">読解テク: NOT問題では「本文に書かれていること」を1つずつ消去。最後に残ったもの（本文にない情報）が正答。</div>`
  },
  {
    id: 307,
    number: 22,
    ...
    answer: "C",
    explanation: `<p><strong>正答: C</strong></p><p><strong>該当英文:</strong> "Valid driver's license and work permit (foreign nationals)"</p><h4>解説</h4><p>就労許可（work permit）は括弧書きで "(foreign nationals)"（外国人）とあり、外国人のみに必要な条件。日本人には不要。</p><h4>誤答選択肢の分析</h4><ul><li>A「ホスピタリティ業界での実務経験」→ 全候補者に必要</li><li>B「中国語スキル」→ 全候補者に必要</li><li>D「友好的でダイナミックな性格」→ 全候補者に必要</li><li>E「コンピュータスキル」→ 全候補者に必要</li></ul><div class="tip">読解テク: 括弧書き "(foreign nationals)" は適用対象の限定を示す。括弧内の条件を見落とさないこと。</div>`
  },
  {
    id: 308,
    number: 23,
    ...
    answer: "D",
    explanation: `<p><strong>正答: D</strong></p><p><strong>該当英文:</strong> "an essential factor to our enjoyment of food is our sense of taste"</p><h4>解説</h4><p>食事を楽しむために不可欠な要素は「味覚」（sense of taste）。</p><h4>誤答選択肢の分析</h4><ul><li>A「少量の調味料」→ 調味料は控えめが良いと述べているが不可欠な要素としては挙げていない</li><li>B「様々な風味」→ 本文の主題ではない</li><li>C「母親の料理」→ 母親は赤ちゃんに薄味を与えるよう勧められているだけ</li><li>E「新鮮な味」→ 不可欠な要素として挙げられているのは味覚</li></ul><div class="tip">読解テク: "an essential factor... is..." の構文はそのまま答えになる。is の後の名詞句を選択肢から探す。</div>`
  },
  {
    id: 309,
    number: 24,
    ...
    answer: "C",
    explanation: `<p><strong>正答: C</strong></p><p><strong>該当英文:</strong> "someone with a good sense of taste who can identify the delicate differences between foods may enjoy meals more than someone who cannot"</p><h4>解説</h4><p>食べ物の微妙な違いを識別できる人（味に敏感な人）がより食事を楽しめる。</p><h4>誤答選択肢の分析</h4><ul><li>A「食べ物の好き嫌いが激しい人」→ 好き嫌いは食事の楽しみとは関係ない</li><li>B「食べ物に意識的な人」→ 意識的であることは触れられているが本文が直接述べているのは味覚の感度</li><li>D「良い食習慣を身につけた人」→ 食習慣は言及されているが食事の楽しみとの関連としては述べられていない</li><li>E「健康を気にする人」→ 健康は触れられているが食事の楽しみとの関連としては述べられていない</li></ul><div class="tip">読解テク: "a good sense of taste" = 味覚が鋭い = 味に敏感。キーフレーズの言い換えパターンを見抜く。</div>`
  },
];
